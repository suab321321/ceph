...
bool verify_object_permission(const DoutPrefixProvider* dpp, struct req_state *s, uint64_t op, Jager_Tracer& tracer, const Span& parent_span)
{
  Span span=tracer.child_span("rgw_common.cc verify_object_permission(const DoutPrefixProvider* dpp, struct req_state *s, uint64_t op)",parent_span);
  perm_state_from_req_state ps(s);
...
std::unordered_map<int, const char*> RGWOpTypeMapper={
  {0,"RGW_OP_UNKNOWN"},
  {1,"RGW_OP_GET_OBJ"},
  {2,"RGW_OP_LIST_BUCKETS"},
  {3,"RGW_OP_STAT_ACCOUNT"},
  {4,"RGW_OP_LIST_BUCKET"},
  {5,"RGW_OP_GET_BUCKET_LOGGING"},
  {6,"RGW_OP_GET_BUCKET_LOCATION"},
  {7,"RGW_OP_GET_BUCKET_VERSIONING"},
  {8,"RGW_OP_SET_BUCKET_VERSIONING"},
  {9,"RGW_OP_GET_BUCKET_WEBSITE"},
  {10,"RGW_OP_SET_BUCKET_WEBSITE"},
  {11,"RGW_OP_STAT_BUCKET"},
  {12,"RGW_OP_CREATE_BUCKET"},
  {13,"RGW_OP_DELETE_BUCKET"},
  {14,"RGW_OP_PUT_OBJ"},
  {15,"RGW_OP_STAT_OBJ"},
  {16,"RGW_OP_POST_OBJ"},
  {17,"RGW_OP_PUT_METADATA_ACCOUNT"},
  {18,"RGW_OP_PUT_METADATA_BUCKET"},
  {19,"RGW_OP_PUT_METADATA_OBJECT"},
  {20,"RGW_OP_SET_TEMPURL"},
  {21,"RGW_OP_DELETE_OBJ"},
  {22,"RGW_OP_COPY_OBJ"},
  {23,"RGW_OP_GET_ACLS"},
  {24,"RGW_OP_PUT_ACLS"},
  {25,"RGW_OP_GET_CORS"},
  {26,"RGW_OP_PUT_CORS"},
  {27,"RGW_OP_DELETE_CORS"},
  {28,"RGW_OP_OPTIONS_CORS"},
  {29,"RGW_OP_GET_REQUEST_PAYMENT"},
  {30,"RGW_OP_SET_REQUEST_PAYMENT"},
  {31,"RGW_OP_INIT_MULTIPART"},
  {32,"RGW_OP_COMPLETE_MULTIPART"},
  {33,"RGW_OP_ABORT_MULTIPART"},
  {34,"RGW_OP_LIST_MULTIPART"},
  {35,"RGW_OP_LIST_BUCKET_MULTIPARTS"},
  {36,"RGW_OP_DELETE_MULTI_OBJ"},
  {37,"RGW_OP_BULK_DELETE"},
  {38,"RGW_OP_SET_ATTRS"},
  {39,"RGW_OP_GET_CROSS_DOMAIN_POLICY"},
  {40,"RGW_OP_GET_HEALTH_CHECK"},
  {41,"RGW_OP_GET_INFO"},
  {42,"RGW_OP_CREATE_ROLE"},
  {43,"RGW_OP_DELETE_ROLE"},
  {44,"RGW_OP_GET_ROLE"},
  {45,"RGW_OP_MODIFY_ROLE"},
  {46,"RGW_OP_LIST_ROLES"},
  {47,"RGW_OP_PUT_ROLE_POLICY"},
  {48,"RGW_OP_GET_ROLE_POLICY"},
  {49,"RGW_OP_LIST_ROLE_POLICIES"},
  {50,"RGW_OP_DELETE_ROLE_POLICY"},
  {51,"RGW_OP_PUT_BUCKET_POLICY"},
  {52,"RGW_OP_GET_BUCKET_POLICY"},
  {53,"RGW_OP_DELETE_BUCKET_POLICY"},
  {54,"RGW_OP_PUT_OBJ_TAGGING"},
  {55,"RGW_OP_GET_OBJ_TAGGING"},
  {56,"RGW_OP_DELETE_OBJ_TAGGING"},
  {57,"RGW_OP_PUT_LC"},
  {58,"RGW_OP_GET_LC"},
  {59,"RGW_OP_DELETE_LC"},
  {60,"RGW_OP_PUT_USER_POLICY"},
  {61,"RGW_OP_GET_USER_POLICY"},
  {62,"RGW_OP_LIST_USER_POLICIES"},
  {63,"RGW_OP_DELETE_USER_POLICY"},
  {64,"RGW_OP_PUT_BUCKET_OBJ_LOCK"},
  {65,"RGW_OP_GET_BUCKET_OBJ_LOCK"},
  {66,"RGW_OP_PUT_OBJ_RETENTION"},
  {67,"RGW_OP_GET_OBJ_RETENTION"},
  {68,"RGW_OP_PUT_OBJ_LEGAL_HOLD"},
  {69,"RGW_OP_GET_OBJ_LEGAL_HOLD"},
  {70,"RGW_OP_ADMIN_SET_METADATA"},
  {71,"RGW_OP_GET_OBJ_LAYOUT"},
  {72,"RGW_OP_BULK_UPLOAD"},
  {73,"RGW_OP_METADATA_SEARCH"},
  {74,"RGW_OP_CONFIG_BUCKET_META_SEARCH"},
  {75,"RGW_OP_GET_BUCKET_META_SEARCH"},
  {76,"RGW_OP_DEL_BUCKET_META_SEARCH"},
  {77,"RGW_STS_ASSUME_ROLE"},
  {78,"RGW_STS_GET_SESSION_TOKEN"},
  {79,"RGW_STS_ASSUME_ROLE_WEB_IDENTITY"},
  {80,"RGW_OP_PUBSUB_TOPIC_CREATE"},
  {81,"RGW_OP_PUBSUB_TOPICS_LIST"},
  {82,"RGW_OP_PUBSUB_TOPIC_GET"},
  {83,"RGW_OP_PUBSUB_TOPIC_DELETE"},
  {84,"RGW_OP_PUBSUB_SUB_CREATE"},
  {85,"RGW_OP_PUBSUB_SUB_GET"},
  {86,"RGW_OP_PUBSUB_SUB_DELETE"},
  {87,"RGW_OP_PUBSUB_SUB_PULL"},
  {88,"RGW_OP_PUBSUB_SUB_ACK"},
  {89,"RGW_OP_PUBSUB_NOTIF_CREATE"},
  {90,"RGW_OP_PUBSUB_NOTIF_DELETE"},
  {91,"RGW_OP_PUBSUB_NOTIF_LIST"},
  {92,"RGW_OP_GET_BUCKET_TAGGING"},
  {93,"RGW_OP_PUT_BUCKET_TAGGING"},
  {94,"RGW_OP_DELETE_BUCKET_TAGGING"},
  {95,"RGW_OP_GET_BUCKET_REPLICATION"},
  {96,"RGW_OP_PUT_BUCKET_REPLICATION"},
  {97,"RGW_OP_DELETE_BUCKET_REPLICATION"},
  {98,"RGW_OP_GET_BUCKET_POLICY_STATUS"},
  {99,"RGW_OP_PUT_BUCKET_PUBLIC_ACCESS_BLOCK"},
