...
class ObjectProcessor : public DataProcessor {
 public:
  ...
  virtual int prepare(optional_yield y, optional_span* parent_span = nullptr) = 0;
  ...
  virtual int complete(size_t accounted_size, const std::string& etag,
                       ...
                       optional_yield y, optional_span* parent_span = nullptr) = 0;
};
...
class AtomicObjectProcessor : public ManifestObjectProcessor {
 ...
 public:
  ...
  int prepare(optional_yield y, optional_span* parent_span = nullptr) override;
  ...
  int complete(size_t accounted_size, const std::string& etag,
               ...
               const std::string *user_data,
               rgw_zone_set *zones_trace, bool *canceled,
               optional_yield y, optional_span* parent_span = nullptr) override;
