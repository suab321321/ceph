...
int rgw_init_ioctx(librados::Rados *rados, const rgw_pool& pool,
		   ...
		   bool create = false,
		   bool mostly_omap = false, optional_span* parent_span = NULL);
...
int rgw_rados_operate(librados::IoCtx& ioctx, const std::string& oid,
                      librados::ObjectReadOperation *op, bufferlist* pbl,
                      int flags, optional_yield y, optional_span* parent_span = NULL);
int rgw_rados_operate(librados::IoCtx& ioctx, const std::string& oid,
                      librados::ObjectWriteOperation *op, optional_yield y, optional_span* parent_span = NULL);
int rgw_rados_operate(librados::IoCtx& ioctx, const std::string& oid,
                      librados::ObjectWriteOperation *op, int flags, optional_yield y, optional_span* parent_span = NULL);
