                                    ...
                                    optional_yield y)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::swift_versioning_copy", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::swift_versioning_copy", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
                                           ...
                                           void *_index_op, optional_yield y)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::Object::Write::_do_write_meta", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::Object::Write::_do_write_meta", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
  ...
  if (!ptag && !index_op->get_optag()->empty()) {
    ...
    Span span_1;
    if(s && !s->stack_span.empty())
      span_1 = tracer_2.child_span("rgw_rados.cc : RGWRados::Object::prepare_atomic_modification", s->stack_span.top());
  ...
  if (meta.data) {
    /* if we want to overwrite the data, we also want to overwrite the
      ...
      Span span_2;
      if(s && !s->stack_span.empty())
        span_2 = tracer_2.child_span("librados.hpp : ObjectWriteOperation::write_full", s->stack_span.top());
  ...
  tracepoint(rgw_rados, operate_enter, req_id.c_str());
    ...
    Span span_3;
    if(s && !s->stack_span.empty())
      span_3 = tracer_2.child_span("rgw_tools.cc : rgw_rados_operate", s->stack_span.top());
  ...
  poolid = ioctx.get_id();
  {
      ...
      Span span_4;
      if(s && !s->stack_span.empty())
        span_4 = tracer_2.child_span("rgw_rados.cc : RGWRados::Object::complete_atomic_modification", s->stack_span.top());
  ...
  if (meta.completeMultipart){
      ...
      Span span_5;
      if(s && !s->stack_span.empty())
        span_5 = tracer_2.child_span("rgw_quota.cc : update_stats", s->stack_span.top());
               ...
               std::optional<uint64_t>* bytes_transferred)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::fetch_remote_obj", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::fetch_remote_obj", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
                                      ...
                                      real_time *mtime)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc : RGWRados::copy_obj_to_remote_dest", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc : RGWRados::copy_obj_to_remote_dest", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
  ...
  int ret;
    ...
    Span span_1;
    if(s && !s->stack_span.empty())
      span_1 = tracer_2.child_span("rgw_rest_conn.cc : GWRESTConn::put_obj_async", s->stack_span.top());
  ...
  if (ret < 0) {
    ...
    Span span_2;
    if(s && !s->stack_span.empty())
      span_2 = tracer_2.child_span("rgw_rest_conn.cc : GWRESTConn::complete_request", s->stack_span.top());
               ...
               optional_yield y)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::copy_obj", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::copy_obj", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
  ...
  uint64_t max_chunk_size;
    ...
    Span span_1;
    if(s && !s->stack_span.empty())
      span_1 = tracer_2.child_span("rgw_rados.cc : RGWRados::get_max_chunk_size", s->stack_span.top());
  ...
  if (!copy_itself) {
    ...
    for (; miter != astate->manifest->obj_end(); ++miter) {
      ...
      ioctx.locator_set_key(loc.loc);
        ...
        Span span_2;
        if(s && !s->stack_span.empty())
          span_2 = tracer_2.child_span("rgw_tools.cc : rgw_rados_operate", s->stack_span.top());
               ...
               optional_yield y)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::copy_obj_data", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::copy_obj_data", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
  ...
  // flush
    ...
    Span span_1;
    if(s && !s->stack_span.empty())
      span_1 = tracer_2.child_span("rgw_putobj_processor.cc : HeadObjectProcesssor::processor", s->stack_span.top());    
...
int RGWRados::delete_bucket(RGWBucketInfo& bucket_info, RGWObjVersionTracker& objv_tracker, optional_yield y, bool check_empty)
{
  ...
  int r;
    ...
    Span span_1;
    if(s && !s->stack_span.empty())
      span_1 = tracer_2.child_span("svc_bi_rados.cc : RGWSI_BucketIndex_RADOS::open_bucket_index", s->stack_span.top());
  ...
  if (objv_tracker.read_version.empty()) {
    RGWBucketEntryPoint ep;
      ...
      Span span_1;
      if(s && !s->stack_span.empty())
        span_1 = tracer_2.child_span("rgw_bucket.cc : RGWBucketCtl::read_bucket_entrypoint_info", s->stack_span.top());
  ...
  if (remove_ep) {
      ...
      Span span_2;
      if(s && !s->stack_span.empty())
        span_2 = tracer_2.child_span("rgw_bucket.cc : remove_bucket_entrypoint_info", s->stack_span.top());
  ...
  if (!svc.zone->is_syncing_bucket_meta(bucket)) {
    RGWObjVersionTracker objv_tracker;
      ...
      Span span_3;
      if(s && !s->stack_span.empty())
        span_3 = tracer_2.child_span("rgw_bucket.cc : remove_bucket_instance_info", s->stack_span.top());
...
int RGWRados::Object::Delete::delete_obj(optional_yield y)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::Object::Delete::delete_obj", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::Object::Delete::delete_obj",s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
  ...
  if (params.versioning_status & BUCKET_VERSIONED || explicit_marker_version) {
    if (instance.empty() || explicit_marker_version) {
      ...
      int r;
        ...
        Span span_1;
        if(s && !s->stack_span.empty())
          span_1 = tracer_2.child_span("rgw_rados.cc : RGWRados::set_olh", s->stack_span.top());
        r = store->set_olh(target->get_ctx(), target->get_bucket_info(), marker, true, &meta, params.olh_epoch, params.unmod_since, params.high_precision_time, y, params.zones_trace);
      #else
        r = store->set_olh(target->get_ctx(), target->get_bucket_info(), marker, true, &meta, params.olh_epoch, params.unmod_since, params.high_precision_time, y, params.zones_trace);
      #endif
      if (r < 0) {
      ...
      int r;
        ...
        Span span_2;
        if(s && !s->stack_span.empty())
          span_2 = tracer_2.child_span("rgw_rados.cc : RGWRados::bi_get_instance", s->stack_span.top());
        r = store->bi_get_instance(target->get_bucket_info(), obj, &dirent);
      #else
        r = store->bi_get_instance(target->get_bucket_info(), obj, &dirent);
      #endif
      if (r < 0) {
      ...
      result.delete_marker = dirent.is_delete_marker();
        ...
        Span span_3;
        if(s && !s->stack_span.empty())
          span_3 = tracer_2.child_span("rgw_rados.cc : RGWRados::unlink_obj_instance", s->stack_span.top());
    ...
    if (r < 0) {
      ...
      Span span_4;
      if(s && !s->stack_span.empty())
        span_4 = tracer_2.child_span("svc_datalog.cc : RGWSI_DataLog_RADOS::add_entry", s->stack_span.top());
  ...
  int r;
      ...
      Span span_5;
      if(s && !s->stack_span.empty())
        span_5 = tracer_2.child_span("rgw_rados.cc : RGWRados::get_obj_head_ref", s->stack_span.top());
    r = store->get_obj_head_ref(target->get_bucket_info(), obj, &ref);
  #else
    r = store->get_obj_head_ref(target->get_bucket_info(), obj, &ref);
  #endif
  ...
  if (!state->exists) {
    ...
    Span span_6;
    if(s && !s->stack_span.empty())
      span_6 = tracer_2.child_span("rgw_rados.cc : RGWRados::Object::prepare_atomic_modification", s->stack_span.top());
  ...
  if (r < 0)
    ...
    Span span_7;
    if(s && !s->stack_span.empty())
      span_7 = tracer_2.child_span("rgw_rados.cc : RGWRados::remove_rgw_head_obj", s->stack_span.top());
  ...
  auto& ioctx = ref.pool.ioctx();
    ...
    Span span_8;
    if(s && !s->stack_span.empty())
      span_8 = tracer_2.child_span("rgw_tools.cc : rgw_rados_operate", s->stack_span.top());
  ...
  if (r >= 0) {
    ...
    int ret;
      ...
      Span span_9;
      if(s && !s->stack_span.empty())
        span_9 = tracer_2.child_span("rgw_rados.cc : RGWRados::Object::complete_atomic_modification", s->stack_span.top());
      ret = target->complete_atomic_modification();
    #else
      ret = target->complete_atomic_modification();
    #endif
    if (ret < 0) {
  ...
  /* update quota cache */
      ...
      Span span_10;
      if(s && !s->stack_span.empty())
        span_10 = tracer_2.child_span("rgw_quota.cc : update_stats", s->stack_span.top());
...
int RGWRados::Bucket::UpdateIndex::prepare(RGWModifyOp op, const string *write_tag, optional_yield y)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::Bucket::UpdateIndex::prepare", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::Bucket::UpdateIndex::prepare", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
                                            ...
                                            bool appendable)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::Bucket::UpdateIndex::complete", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::Bucket::UpdateIndex::complete", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
  ...
  ent.meta.appendable = appendable;
    ...
    Span span_1;
    if(s && !s->stack_span.empty())
      span_1 = tracer_2.child_span("rgw_rados.cc : RGWRados::cls_obj_complete_add", s->stack_span.top());
  ...
  int r;
    ...
    Span span_2;
    if(s && !s->stack_span.empty())
      span_2 = tracer_2.child_span("svc_datalog_rados.cc : RGWSI_DataLog_RADOS::add_entry", s->stack_span.top());
    r = store->svc.datalog_rados->add_entry(target->bucket_info, bs->shard_id);
  #else
    r = store->svc.datalog_rados->add_entry(target->bucket_info, bs->shard_id);
  #endif
                      ...
                      optional_yield y, rgw_zone_set *zones_trace, bool log_data_change)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::set_olh", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::set_olh", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
				       ...
				       optional_yield y)
{
  ...
  span_structure ss;
    ...
    Span span;
    if(s && !s->stack_span.empty()){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::get_bucket_instance_info", s->stack_span.top());
      ss.set_req_state(s);
      ss.set_span(span);
    }
    else if(s && s->root_span){
      span = tracer_2.child_span("rgw_rados.cc RGWRados::get_bucket_instance_info", s->root_span);
      ss.set_req_state(s);
      ss.set_span(span);
    }
  #endif
  ...
  if (shard_id >= 0) {
	...
	"start marker: '" << start_after << "'" << dendl;
      ...
      // and can extract the specific shard from it
        ...
        Span span_2;
        if(s && !s->stack_span.empty())
          span_2 = tracer_2.child_span("svc_bi_rados.cc : RGWSI_BucketIndex_RADOS::bucket_shard_index", s->stack_span.top());
