...
class RGWUser {
  ...
  public:
    ...
    virtual int list_buckets(const string& marker, const string& end_marker,
			     uint64_t max, bool need_stats, RGWBucketList& buckets, optional_span* parent_span = NULL) = 0;
...
class RGWBucket {
  ...
  public:
    ...
    virtual int update_container_stats(optional_span* parent_span = NULL) = 0;
...
class RGWRadosUser : public RGWUser {
  ...
  public:
    ...
    int list_buckets(const string& marker, const string& end_marker,
				uint64_t max, bool need_stats, RGWBucketList& buckets, optional_span* parent_span = NULL);
...
class RGWRadosBucket : public RGWBucket {
  ...
  public:
    ...
    virtual int update_container_stats(optional_span* parent_span = NULL) override;
